...
begin
  ...
  begin
    ...
    ValuesGrid.Cells[6, i + 1] := FloatToStrF(gValues.G[i] / GFactor, ffFixed, 0, 4);
    ValuesGrid.Cells[7, i + 1] := FloatToStrF(gValues.S[i] / PicoFactor, ffFixed, 0, 4);
    ValuesGrid.Cells[8, i + 1] := FloatToStrF(gValues.I[i] / IFactor, ffFixed, 0, 4);
