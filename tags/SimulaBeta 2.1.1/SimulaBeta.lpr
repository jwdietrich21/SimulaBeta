...
uses
  ...
  Controls, Forms, tachartlazaruspkg, Classes, Sysutils,
  GUI, SimulationEngine, IPS, Plot, prediction, LogGrid, SimulationControl,
  SimulaBetaBaseServices, SimulaBetaGUIServices, EnvironmentInfo;
