...
begin
  ...
  PredictionList.Cells[1, 5] := FloatToStrF(Parameters[0].G / MilliFactor * gGlucoseConversionFactor, ffFixed, 0, 4) + ' ' + gUnits.G;
  PredictionList.Cells[1, 6] := FloatToStrF(Parameters[0].S / PicoFactor, ffFixed, 0, 4) + ' ' + gUnits.S;
  PredictionList.Cells[1, 7] := FloatToStrF(Parameters[0].I / PicoFactor * gInsulinConversionFactor, ffFixed, 0, 4) + ' ' + gUnits.I;
  ...
  PredictionList.Cells[2, 5] := FloatToStrF(Parameters[1].G / MilliFactor * gGlucoseConversionFactor, ffFixed, 0, 4) + ' ' + gUnits.G;
  PredictionList.Cells[2, 6] := FloatToStrF(Parameters[1].S / PicoFactor, ffFixed, 0, 4) + ' ' + gUnits.S;
  PredictionList.Cells[2, 7] := FloatToStrF(Parameters[1].I / PicoFactor * gInsulinConversionFactor, ffFixed, 0, 4) + ' ' + gUnits.I;
