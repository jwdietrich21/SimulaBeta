...
begin
  ...
  begin
    ...
    ValuesGrid.Cells[2, i + 1] := FormatFloat(gNumberFormat, gValues.P[i] / PFactor);
    ValuesGrid.Cells[3, i + 1] := FormatFloat(gNumberFormat, gValues.W[i] / MicroFactor);
    ValuesGrid.Cells[4, i + 1] := FormatFloat(gNumberFormat, gValues.Q[i] / MicroFactor);
    ValuesGrid.Cells[5, i + 1] := FormatFloat(gNumberFormat, gValues.R[i] / MicroFactor);
    ValuesGrid.Cells[6, i + 1] := FormatFloat(gNumberFormat, gValues.G[i] / GFactor * gGlucoseConversionFactor);
    ValuesGrid.Cells[7, i + 1] := FormatFloat(gNumberFormat, gValues.S[i] / PicoFactor);
    ValuesGrid.Cells[8, i + 1] := FormatFloat(gNumberFormat, gValues.I[i] / IFactor * gInsulinConversionFactor);
    ValuesGrid.Cells[9, i + 1] := FormatFloat(gNumberFormat, gValues.M[i]);
    ValuesGrid.Cells[10, i + 1] := FormatFloat(gNumberFormat, gValues.N[i]);
  end;
